...
genai_client = genai.Client(api_key="AIzaSyCuHHdoTPjSTJ4IQoDtsa7nKefXOI8VFf8")

# Groq models
from groq import Groq
groq_client = Groq(api_key="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")
